...
* <https://github.com/treeverse/lakeFS/[lakeFS> ⭐ 5,495 | 🐛 439 | 🌐 Go | 📅 2026-08-19] - Repeatable, atomic and versioned data lake on top of object storage.

\== Workflow Management

* <https://github.com/PrefectHQ/prefect/[Prefect> ⭐ 23,677 | 🐛 862 | 🌐 Python | 📅 2026-08-25] - A workflow management system designed for modern infrastructure.
* <https://github.com/dagster-io/dagster/[Dagster> ⭐ 16,059 | 🐛 2,587 | 🌐 Python | 📅 2026-08-24] - A data orchestrator for machine learning, analytics, and ETL.
