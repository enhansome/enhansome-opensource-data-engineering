...
This is a community effort: please <https://github.com/gunnarmorling/awesome-opensource-data-engineering/blob/master/CONTRIBUTING.md[contribute> ⭐ 3,297 | 🐛 26 | 📅 2024-10-04] and send your pull requests for growing this list!
...
* <https://github.com/treeverse/lakeFS/[lakeFS> ⭐ 5,543 | 🐛 446 | 🌐 Go | 📅 2026-09-24] - Repeatable, atomic and versioned data lake on top of object storage.

\== Workflow Management

* <https://github.com/PrefectHQ/prefect/[Prefect> ⭐ 23,923 | 🐛 859 | 🌐 Python | 📅 2026-09-25] - A workflow management system designed for modern infrastructure.
* <https://github.com/dagster-io/dagster/[Dagster> ⭐ 16,198 | 🐛 2,572 | 🌐 Python | 📅 2026-09-25] - A data orchestrator for machine learning, analytics, and ETL.
