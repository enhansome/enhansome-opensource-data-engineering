...
This is a community effort: please <https://github.com/gunnarmorling/awesome-opensource-data-engineering/blob/master/CONTRIBUTING.md[contribute> ⭐ 3,283 | 🐛 25 | 📅 2024-10-04] and send your pull requests for growing this list!
...
* <https://github.com/treeverse/lakeFS/[lakeFS> ⭐ 5,519 | 🐛 441 | 🌐 Go | 📅 2026-08-19] - Repeatable, atomic and versioned data lake on top of object storage.

\== Workflow Management

* <https://github.com/PrefectHQ/prefect/[Prefect> ⭐ 23,788 | 🐛 862 | 🌐 Python | 📅 2026-09-05] - A workflow management system designed for modern infrastructure.
* <https://github.com/dagster-io/dagster/[Dagster> ⭐ 16,114 | 🐛 2,584 | 🌐 Python | 📅 2026-09-04] - A data orchestrator for machine learning, analytics, and ETL.
